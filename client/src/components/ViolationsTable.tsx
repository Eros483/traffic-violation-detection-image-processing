// Violations data grid. Dense, bordered, shaded sticky header with a 2px base
// rule. Subtle alternating row tint (not zebra). Identifiers monospaced.

import { displaySection, formatDateTime } from "../lib/format";
import type { ViolationRecord } from "../lib/types";
import { ConfidenceChip, PlateText, SeverityChip, TypeTags } from "./ui";
          ...
          {records.map((r, i) => {
            ...
            return (
              ...
              >
                ...
                <td className={TD}>
                  <PlateText plate={r.plate_number} />
                </td>
                <td className={TD}>
                ...
                <td className={TD}>
                  <ConfidenceChip value={topConfidence(r)} />
                </td>
