// Exact mirror of the read-only backend (api/schemas.py, src/evidence.py, and
// the JSONL records). Do not add fields the backend does not emit.
...
/** One line of outputs/violations.jsonl. */
